    ...
    if (isset($_POST["btn_login"])) {
        ...
        if ($true_name==$name ){
            if ($true_password==$password)
            {
                ...
                echo "<span class='badge badge-danger'> Email is correct and Password incorrect</span>";
            }
        }elseif ($true_name!=$name){
            if ($true_password==$password)
            {
                echo "<span class='badge badge-danger'>Email is incorrect and Password correct</span>";
            }else{
                echo "<span class='badge badge-danger'>Email and password is incorrect</span>";
            }
        }
    }
}
